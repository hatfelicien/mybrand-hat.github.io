...
function validateLogin() {
    ...
    if (!emailRegex.test(loginEmail)) {
        document.getElementById("errorLoginEmail").innerHTML = "Invalid email format";
        return;
    }

    // Validate password length
    if (loginPassword.length < 6) {
        document.getElementById("errorLoginPassword").innerHTML = "Password should be at least 6 characters"
        return;
    }
